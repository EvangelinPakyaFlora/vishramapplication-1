  ...
  Future showdialog(BuildContext context,String message)async{
    return showDialog(barrierDismissible: false,
       builder: (context) => Container(
         ...
         height: 200,
         child: new AlertDialog(insetPadding: EdgeInsets.symmetric(horizontal: 300,vertical: 300),
           ...
           shape: RoundedRectangleBorder(
             ...
             title: SizedBox(
                 height: 250,
                 width: 250,
                 child: Center(child: new Text(message))),
           actions: [
             FlatButton(onPressed: ()=>Navigator.pop(context), child: new Text("ok"))
           ],
